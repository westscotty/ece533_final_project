...
\begin{table}
    ...
    & & \\
    & & \\
    \multirow{4}{*}{Shi-Tomasi} & \multirow{4}{*}{\parbox{3.25cm}{\raggedright maxCorners: 693\\qualityLevel: 0.0838\\minDistance: 5\\blockSize: 5}} & \multirow{4}{*}{250}  & \multirow{4}{*}{0.2743} \\
    & & \\
    & & \\
    & & \\
    & & \\
    & & \\
    \multirow{2}{*}{FAST} & \multirow{2}{*}{\parbox{3.25cm}{\raggedright threshold: 48\\type: 2}} & \multirow{2}{*}{250}  & \multirow{2}{*}{0.3404} \\
    & & \\
    & & \\
    & & \\
    \multirow{6}{*}{ORB} & \multirow{6}{*}{\parbox{3.25cm}{\raggedright nfeatures: 4631\\scaleFactor: 1.3201\\nlevels: 14\\edgeThreshold: 30\\patchSize: 39\\fastThreshold: 37}} & \multirow{6}{*}{250}  & \multirow{6}{*}{0.3122} \\
    & & \\
    & & \\
    & & \\
    & & \\
    ...
    & & \\
    & & \\
    \multirow{4}{*}{SIFT} & \multirow{4}{*}{\parbox{3.25cm}{\raggedright nOctaveLayers: 2\\contrastThreshold: 0.1008\\edgeThreshold: 28\\sigma: 1.6977}} & \multirow{4}{*}{250}  & \multirow{4}{*}{0.3049} \\
    & & \\
    & & \\
    & & \\
    & & \\
    & & \\
    \multirow{3}{*}{BRISK} & \multirow{3}{*}{\parbox{3.25cm}{\raggedright thresh: 12\\octaves: 4\\patternScale: 0.5133}} & \multirow{3}{*}{250}  & \multirow{3}{*}{0.2965} \\
    & & \\
    & & \\
    & & \\
    & & \\
    \multirow{2}{*}{AGAST} & \multirow{2}{*}{\parbox{3.25cm}{\raggedright threshold: 33\\type: 0}} & \multirow{2}{*}{250}  & \multirow{2}{*}{0.3579} \\
    & & \\
    & & \\
    & & \\
    \multirow{4}{*}{KAZE} & \multirow{4}{*}{\parbox{3.25cm}{\raggedright threshold: 0.0023\\nOctaves: 2\\nOctaveLayers: 2\\diffusivity: 2}} & \multirow{4}{*}{250}  & \multirow{4}{*}{0.3364} \\
    & & \\
    & & \\
    & & \\
    & & \\
    & & \\
    \multirow{4}{*}{AKAZE} & \multirow{4}{*}{\parbox{3.25cm}{\raggedright threshold: 0.0019\\nOctaves: 3\\nOctaveLayers: 4\\diffusivity: 0}} & \multirow{4}{*}{250}  & \multirow{4}{*}{0.3556} \\
    & & \\
    & & \\
    & & \\
    & & \\
...
\begin{table}[t]
    ...
    \small
    \caption{Best Mean Scale Invariance Scores for Corner Detection Algorithms}
...
\begin{table}
    ...
    \midrule
    Harris & 0.002 & 0.318 & 0.318 & 0.0004 & 0.004 & 0.160 & 1.337 & 0.000 \\
    Shi-Tomasi & 0.073 & 0.102 & 0.102 & 0.0003 & 0.073 & 0.088 & 1.960 & 0.185 \\
    FAST & 0.070 & 0.117 & 0.117 & 0.0001 & 0.075 & 0.093 & 1.961 & 0.144 \\
    ORB & 0.037 & 0.131 & 0.131 & 0.0005 & 0.050 & 0.084 & 1.997 & 0.143 \\
    SIFT & 0.057 & 0.062 & 0.062 & 0.0059 & 0.054 & 0.059 & 2.115 & 0.087 \\
    BRISK & 0.025 & 0.439 & 0.439 & 0.0322 & 0.044 & 0.232 & 2.252 & 0.003 \\
    AGAST & 0.069 & 0.101 & 0.101 & 0.0002 & 0.049 & 0.085 & 1.843 & 0.136 \\
    KAZE & 0.131 & 0.022 & 0.022 & 0.0039 & 0.033 & 0.076 & 1.331 & 0.085 \\
    AKAZE & 0.076 & 0.053 & 0.053 & 0.0033 & 0.059 & 0.064 & 1.855 & 0.208 \\
    \bottomrule
    \end{tabular}
    \end{minipage}
    }
