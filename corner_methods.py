...
def harris(image, args=None, corners=None):
...
def shi_tomasi(image, args=None, corners=None):
...
def fast(image, args=None, corners=None):
...
def orb(image, args=None, corners=None):
...
def sift(image, args=None, corners=None):
...
def brisk(image, args=None, corners=None):
...
def agast(image, args=None, corners=None):
...
def kaze(image, args=None, corners=None):
...
def akaze(image, args=None, corners=None):
